      ...
      <React.Fragment>
          ...
          <div className="navbar-collapse h-100 d-flex flex-column justify-content-center align-items-stretch position-fixed" id="navbarNavAltMarkup">
            <div className="navbar-nav">
              ...
              <button className={`nav-item d-flex justify-content-center align-items-center nav-link ${props.activePage===Pages.ABOUTME?'active':''}`} onClick={(evt)=>props.onDisplayNewPage(Pages.ABOUTME)}>ABOUTME</button>
